    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>HELLLLLO</p>
          <p>WELCOME Student, <?php echo $fname; ?>!</p>
    ...
    <section class="content">
      ...
      <div class="row">
            ...
            <div class="col-sm-8" align="center">
                  <h1>SOUTHERN LUZON STSAATE UNIVERSITY<br />COLLEGE OF ENGINEERING</h1>
                  <h3>Online QualitativsaSasae Contribution Evaluation for Instruction/Teaching <br />Effectiveness of COE Instructors<br />
                   Rating Period: <br />
                   School Year: </h3>
                   <hr/>
            </div>
      ...
      <div class="row">
            ...
            <div class="col-sm-12" align="center">
               <label for="faculty"><b>Name of Faculty:</b></label><select class="selectpicker show-pick form-control"><option></option></select>
            </div>

            <div class="col-sm-6" align="center">
               <label for="section" >Section</label><select class="selectpicker show-pick form-control"><option></option></select>
            </div>
            <div class="col-sm-6" align="center">
             <label for="subject">Subject</label><select class="selectpicker show-pick form-control"><option></option></select>
           </div>
      </div>
