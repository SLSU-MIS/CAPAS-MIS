    ...
    <section class="content">
      ...
      <div class="row">
            ...
            <div class="col-sm-6" align="center">
               <label for="section" >College</label><select class="selectpicker show-pick form-control"><option></option></select>
            </div>
            <div class="col-sm-6" align="center">
             <label for="subject">Department</label><select class="selectpicker show-pick form-control"><option></option></select>
           </div>
      </div>
