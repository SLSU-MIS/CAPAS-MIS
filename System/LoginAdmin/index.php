                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            ...
                            <div class="description">
                            	<p>
	                            	<strong>Administration Mode for Evaluation System</strong><br>
                           ...
                           <?php 
                        	...
                        	<div class="form-top">
                        		<div class="form-top-left">
                            		...
                            		<p>Enter Your Admin Id No. and Password</p>
                        		</div>
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="login.php" method="post" class="login-form">
			                    	<div class="form-group">
			                        	...
			                        	<input type="text" placeholder="Admin ID Number:" class="form-username form-control" 
                                        name="username">
			                        </div>
			                        <div class="form-group">
