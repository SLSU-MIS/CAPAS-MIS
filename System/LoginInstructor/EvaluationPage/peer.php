  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        echo '<a href="dean.php" class="btn btn-warning"/>Dean Evaluation</a>';

            }
        ?>
        <hr>
        <i class="fa fa-info-circle fa-lg" aria-hidden="true"></i>
        <small>Choose the Button Above the Type of Evaluation You Want to Make</small>
      </h1>
      <ol class="breadcrumb">
   ...
   <form action="peerverify.php" method="post">
      ...
      <div class="row">
            ...
            <div class="col-sm-4" align="left">
               <label for="faculty"><b>College Designation:</b></label>
               

                <select class="selectpicker show-pick form-control" name="ins_college">
                      <?php
                        if ($numresults2 !=0) {
            ...
            <div class="col-sm-4" align="left">
               <label for="faculty"><b>Department Designation:</b></label>
               

                <select class="selectpicker show-pick form-control" name="ins_dept">
                      <?php
                        if ($numresults3 !=0) {
