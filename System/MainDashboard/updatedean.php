...
?>
 ...
 <!--UPDATING SCRIPT-->
                      ...
                      $result = mysql_query("SELECT * FROM dean_evaluator WHERE dean_id='$id'");
                      $row = mysql_fetch_array($result);
                      if (!$result) 
                          {
                          die("Error: Data not found..");
                          }
                              $Fname = $row['dean_first'];
                              $Lname = $row['dean_last'];
                              $Minitial = $row['dean_middle'];
                              $Sid = $row['dean_id'];
                              $College = $row['slct1'];
                      ...
                      { 
                        $fname_update = $_POST['dean_first'];
                        $lname_update = $_POST['dean_last'];
                        $minitial_update = $_POST['dean_middle'];
                        //$sid_update = $_POST['student_id'];
                        $college_update = $_POST['slct1'];
                        $password_update = $_POST['dean_pass'];
                        

                        mysql_query("UPDATE dean_evaluator SET dean_last ='$lname_update',
                        dean_first ='$fname_update',dean_middle ='$minitial_update',
                        dean_college ='$college_update',dean_pass ='$password_update' 
                        WHERE dean_id = '$id'")
                        ...
                        <form class="form-horizontal" method="POST">
                          <div class="box-body">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                <input name="dean_id" type="text" class="form-control" disabled value="<?php echo $Sid ?>" />
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                <input name="dean_last"type="text" class="form-control" value="<?php echo $Lname ?>"/>
                              </div>
                              <div class="col-sm-2">
                                <input name="dean_first" type="text" class="form-control" value="<?php echo $Fname ?>"/>
                              </div>
                              <div class="col-sm-2">
                                <input name="dean_middle" type="text" class="form-control" value="<?php echo $Minitial ?>"/>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                <input name="dean_pass" type="text" class="form-control" value="<?php echo $Password ?>"/>
                              </div>
                            </div>
